var rule = {
    ...
    lazy: '',
    limit: 20,
    推荐: '.section-main&&.module-box-inner&&.module-item;*;*;*;*;*',
    double: false,
    ...
    一级: '.module-box-inner&&.module-item;.v-item-title&&Text;img:last-of-type&&data-original;.v-item-bottom&&span&&Text;a&&href;.v-item-top-left&&span&&Text',
    二级: {
