var rule = {
    ...
    title: '疯狗电影',
    类型: '影视',
    host: 'https://m.fenggoudy3.com', //ttps://m.fenggoudy3.com
    hostJs: '',
    headers: {
    ...
    play_parse: true,
    lazy: `js:
let kcode = JSON.parse(request(input).match(/cms_player = (.*?);</)[1]);
log('***' + kcode);
let kjx = kcode.jiexi;
let kurl = kcode.url;
log('***' + kurl);
...
input = { jx: 0, parse: 1, url:'https://jx.xmflv.cc/?url=' + kurl };
}
`,
